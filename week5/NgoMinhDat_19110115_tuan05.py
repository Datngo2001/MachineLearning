# -*- coding: utf-8 -*-
"""
Created on Fri Apr 15 12:55:54 2022
...
# In[1]: MNIST DATASET
# 1.1. Load MNIST  
train_set = pd.read_csv('NgoMinhDat_19110115_tuan05_data_train.csv')
test_set = pd.read_csv('NgoMinhDat_19110115_tuan05_data_train.csv')
...
if let_plot:
    ...
    X_class_AB = X_train[(y_train == class_A) & (y_train_pred == class_B)]
    plt.subplot(121); 
    plot_digits(X_class_AB[0:25], images_per_row=5)
    plt.title("Actual: " + str(class_A) + ", Predicted: " + str(class_B))
